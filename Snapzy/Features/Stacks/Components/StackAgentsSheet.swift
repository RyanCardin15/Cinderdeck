    ...
    VStack(alignment: .leading, spacing: 16) {
      ...
      section("Command-line tool") {
        HStack(spacing: 8) {
          ...
          Text(cliInstalled ? "snapzy is installed at \(StackCLI.installedLink.path)" : "Install `snapzy` in ~/.local/bin").font(.system(size: 12, weight: .medium))
          Spacer()
        ...
        Text("Try: snapzy stacks status · snapzy stacks start <stack> · snapzy stacks ports · snapzy stacks logs <stack> -f")
