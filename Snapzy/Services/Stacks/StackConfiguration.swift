...
enum StackConfiguration {
  static func write(_ writer: inout SimpleTOMLWriter, defaults: UserDefaults? = nil) {
    ...
    writer.value("directory", defaults?.string(forKey: PreferencesKeys.stacksDirectory) ?? "~/.config/snapzy/stacks")
  ...
  static func collect(_ reader: inout SnapzyConfigurationReader, defaults: UserDefaults, mutations: inout [() -> Void]) {
