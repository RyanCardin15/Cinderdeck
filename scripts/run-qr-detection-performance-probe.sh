...
TMP_ROOT="${TMPDIR:-/tmp}"
BINARY_PATH="${TMP_ROOT%/}/cinderdeck-qr-detection-probe"
MODULE_CACHE_PATH="${TMP_ROOT%/}/cinderdeck-qr-probe-module-cache"
STDERR_PATH="${TMP_ROOT%/}/cinderdeck-qr-detection-probe.stderr"
