...
final class AnnotateCoreTests: XCTestCase {
  ...
  func testSensitiveDataDetectorFindsCommonSensitivePatterns() {
    ...
    let text = """
    Email admin@example.com, URL https://github.com/RyanCardin15/Cinderdeck/share, card 4111 1111 1111 1111,
  ...
  func testSensitiveDataDetectorPrecisionRecallGateMeetsP99OnCuratedCorpus() {
    ...
    let samples: [Sample] = [
      ...
      Sample(text: "URL https://github.com/RyanCardin15/Cinderdeck/share", expectedKinds: [.url]),
  ...
  func testAnnotationFactory_smallWatermarkDragUsesCanvasSizedDefaultBounds() throws {
    ...
    XCTAssertEqual(text, "Cinderdeck")
  ...
  func testAnnotateExporterGenerateCopyURL_incrementsExistingCopies() throws {
    let directory = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_AnnotateCopyURL_\(UUID().uuidString)", isDirectory: true)
  ...
  func testAnnotateCanvasPresetPayloadApproximatelyEqualsIncludesBlurredBackgroundEffect() {
    let wallpaperURL = URL(fileURLWithPath: "/tmp/cinderdeck-wallpaper.png")
  ...
  func testAnnotateStateAppliesDefaultCanvasPresetToNewImageWithoutDirtyFlag() {
    ...
    let state = AnnotateState(
      ...
      url: URL(fileURLWithPath: "/tmp/cinderdeck-default-preset.png"),
  ...
  private func makeContext(
    ...
    counterValue: Int = 1,
    watermarkText: String = "Cinderdeck",
