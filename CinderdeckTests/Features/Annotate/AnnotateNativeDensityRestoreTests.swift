...
final class AnnotateNativeDensityRestoreTests: XCTestCase {
  ...
  override func setUp() {
    ...
    tempDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_AnnotateNativeDensity_\(UUID().uuidString)", isDirectory: true)
  ...
  func testFileDensityScaleFactor_readsCinderdeckWrittenDPI() throws {
