...
final class CaptureHistoryStoreTests: XCTestCase {
  ...
  override func setUp() {
    super.setUp()
    defaultsSuiteName = "CinderdeckTests.CaptureHistoryStoreTests.\(UUID().uuidString)"
    ...
    testDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_CaptureHistoryStore_\(UUID().uuidString)", isDirectory: true)
