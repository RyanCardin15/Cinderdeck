...
final class TempCaptureManagerTests: XCTestCase {
  ...
  override func setUp() {
    ...
    let exportDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_Export_\(UUID().uuidString)", isDirectory: true)
  ...
  private func createExternalTestFile() throws -> URL {
    let dir = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_External_\(UUID().uuidString)", isDirectory: true)
  ...
  func testResolveSaveDirectory_autoSaveOn_returnsExportDir() {
    ...
    let exportDir = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_Export_\(UUID().uuidString)")
  ...
  func testTempCaptureDirectory_isInAppSupport() {
    ...
    XCTAssertTrue(
      path.contains("Application Support/Cinderdeck/Captures")
        || path.contains("Cinderdeck_Captures"),
