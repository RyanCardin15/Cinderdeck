...
final class PostCaptureActionHandlerTests: XCTestCase {
  ...
  override func setUp() async throws {
    ...
    tempDirectory = FileManager.default.temporaryDirectory
      .appendingPathComponent("CinderdeckTests_PostCapture_\(UUID().uuidString)", isDirectory: true)
  ...
  private func saveDefaultPreset(
    padding: CGFloat = 10,
    backgroundStyle: Cinderdeck.BackgroundStyle = .solidColor(SwiftUI.Color.red)
