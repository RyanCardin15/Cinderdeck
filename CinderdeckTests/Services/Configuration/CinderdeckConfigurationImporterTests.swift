//
//  CinderdeckConfigurationImporterTests.swift
//  CinderdeckTests
//
...
final class CinderdeckConfigurationImporterTests: XCTestCase {
  ...
  func testImportExpandsTildePathsAgainstUserHomeDirectory() {
    ...
    XCTAssertEqual(
      ...
      CinderdeckConfigurationPaths.expandedUserPath("~/Desktop")
    )
  }
  ...
  func testImportRejectsInvalidEnumValues() {
    ...
    """
    let result1 = CinderdeckConfigurationImporter.importTOML(sourceInvalidTrackpad, defaults: defaults)
    ...
    """
    let result2 = CinderdeckConfigurationImporter.importTOML(sourceInvalidLeftAction, defaults: defaults)
    ...
    """
    let result3 = CinderdeckConfigurationImporter.importTOML(sourceInvalidAnim, defaults: defaults)
  ...
  func testImportAppliesCustomOCRModelsAndClearsAPIKeyFlag() throws {
    ...
    let result = CinderdeckConfigurationImporter.importTOML(source, defaults: defaults, keychainStore: keychain)
