//
//  CinderdeckOnboardingStep.swift
//  Cinderdeck
//
//  Step models and interactive challenges for Cinderdeck onboarding.
//

import SwiftUI

enum CinderdeckOnboardingStep: String, CaseIterable, Identifiable, Hashable {
  case meetCinderdeck
  case quickAccess
  case shortcuts
  case permissions
  ...
  var shortTitle: String {
    switch self {
    case .meetCinderdeck: return L10n.Onboarding.stepCaptureShortTitle
  ...
  var title: String {
    switch self {
    case .meetCinderdeck: return L10n.Onboarding.stepCaptureTitle
  ...
  var symbol: String {
    switch self {
    case .meetCinderdeck: return "camera.viewfinder"
  ...
  var tip: String {
    switch self {
    case .meetCinderdeck: return L10n.Onboarding.stepCaptureTip
  ...
  var challenges: [CinderdeckOnboardingChallenge] {
    switch self {
    case .meetCinderdeck:
...
enum CinderdeckOnboardingChallenge: String, CaseIterable, Identifiable, Hashable {
  case selectArea
  case addAnnotation
