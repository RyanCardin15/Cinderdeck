//
//  CinderdeckUnevenRoundedRectangle.swift
//  Cinderdeck
//
...
struct CinderdeckCornerRadii: Equatable {
...
struct CinderdeckUnevenRoundedRectangle: Shape, InsettableShape {
  var cornerRadii: CinderdeckCornerRadii
  var insetAmount: CGFloat = 0

  init(cornerRadii: CinderdeckCornerRadii) {
    self.cornerRadii = cornerRadii
  }

  func inset(by amount: CGFloat) -> CinderdeckUnevenRoundedRectangle {
    var copy = self
