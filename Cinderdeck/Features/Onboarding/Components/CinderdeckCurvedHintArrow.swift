//
//  CinderdeckCurvedHintArrow.swift
//  Cinderdeck
//
...
enum CinderdeckHintArrowOrientation {
...
struct CinderdeckCurvedHintArrow: View {
  let text: String
  var orientation: CinderdeckHintArrowOrientation = .curveDownToTarget
