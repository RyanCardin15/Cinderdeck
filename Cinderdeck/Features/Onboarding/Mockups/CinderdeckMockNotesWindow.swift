//
//  CinderdeckMockNotesWindow.swift
//  Cinderdeck
//
...
struct CinderdeckMockNotesWindow: View, Equatable {
  static func == (lhs: CinderdeckMockNotesWindow, rhs: CinderdeckMockNotesWindow) -> Bool {
    true
  }
