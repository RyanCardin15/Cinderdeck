//
//  CinderdeckMockDesktopCanvas.swift
//  Cinderdeck
//
...
enum CinderdeckMockApp: Equatable {
  case notes
  case finder
  case settings
  ...
  var watermarks: [CinderdeckWatermark] {
    switch self {
    case .notes:
      return [
        .init(text: "t For style"),
        .init(text: "Cinderdeck"),
    ...
    case .finder:
      return [
        .init(text: "t For style"),
        .init(text: "Finder"),
        .init(text: "Cinderdeck", size: 30, weight: .heavy, opacity: 0.040),
        .init(text: "Mac 26"),
        .init(text: "Studio", opacity: 0.040),
...
struct CinderdeckMockWallpaper: View, Equatable {
...
struct CinderdeckMockMenuBar: View, Equatable {
  var app: CinderdeckMockApp = .notes
  ...
  var body: some View {
    GeometryReader { proxy in
      ...
      ZStack(alignment: .topLeading) {
        ...
        HStack(spacing: 11) {
          // Cinderdeck Camera Status Icon in subtle capsule
          HStack(spacing: 3) {
