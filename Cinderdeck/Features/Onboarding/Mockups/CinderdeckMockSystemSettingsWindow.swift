//
//  CinderdeckMockSystemSettingsWindow.swift
//  Cinderdeck
//
...
struct CinderdeckMockSystemSettingsWindow: View {
  ...
  private var sheetShortcutsPane: some View {
    VStack(alignment: .leading, spacing: 0) {
      ...
      VStack(spacing: 1) {
        // 1. Fullscreen to file (⇧⌘3) - Conflict with Cinderdeck Fullscreen
        shortcutItemRow(
          id: "screen",
        ...
        // 3. Selected area to file (⇧⌘4) - Conflict with Cinderdeck Area
        shortcutItemRow(
          id: "area",
        ...
        // 5. Screenshot and recording options (⇧⌘5) - Conflict with Cinderdeck Recording
        shortcutItemRow(
          id: "recording",
