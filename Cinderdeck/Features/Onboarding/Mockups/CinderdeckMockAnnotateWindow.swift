//
//  CinderdeckMockAnnotateWindow.swift
//  Cinderdeck
//
//  Faithful mock Annotate Window reflecting Cinderdeck's actual editor layout in sleek Dark Mode:
...
struct CinderdeckMockAnnotateWindow: View {
