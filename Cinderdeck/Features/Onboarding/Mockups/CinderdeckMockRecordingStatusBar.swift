//
//  CinderdeckMockRecordingStatusBar.swift
//  Cinderdeck
//
//  Faithful replica of Cinderdeck's floating RecordingStatusBarView shown during active recording.
//  Layout: [≡] | [● 00:00:0X] | [⏸] [✏️] | [↺] | [🗑] | [Stop]
//

import SwiftUI

struct CinderdeckMockRecordingStatusBar: View {
