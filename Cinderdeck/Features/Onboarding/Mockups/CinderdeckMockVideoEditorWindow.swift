//
//  CinderdeckMockVideoEditorWindow.swift
//  Cinderdeck
//
//  Faithful replica of Cinderdeck's VideoEditorMainView for Step 2 onboarding.
...
struct CinderdeckMockVideoEditorWindow: View {
        ...
        VStack(spacing: 3) {
          ForEach(0..<4) { i in
            HStack(spacing: 6) {
              ...
              Text(["Cinderdeck Captures", "Roadmap.xlsx", "config.toml", "Demo.mp4"][i])
    ...
    VStack(alignment: .leading, spacing: 4) {
      ...
      GeometryReader { geo in
        ...
        ZStack(alignment: .leading) {
          ...
          // Yellow trim border and handles (matching Cinderdeck's VideoEditorVideoTrimHandlesView)
