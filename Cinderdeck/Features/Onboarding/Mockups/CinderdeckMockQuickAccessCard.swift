//
//  CinderdeckMockQuickAccessCard.swift
//  Cinderdeck
//
//  100% faithful Quick Access Card component matching Cinderdeck's actual QuickAccessCardView:
...
struct CinderdeckMockQuickAccessCard: View {
  ...
  var body: some View {
    ZStack(alignment: .center) {
      ...
      // 3. Hover Action Overlay with default Cinderdeck actions
      if isHovering {
        hoverOverlay
