//
//  CinderdeckMockFinderWindow.swift
//  Cinderdeck
//
...
struct CinderdeckMockFinderWindow: View, Equatable {
  static func == (lhs: CinderdeckMockFinderWindow, rhs: CinderdeckMockFinderWindow) -> Bool {
    true
  }
  ...
  private static let items: [FinderRowItem] = [
    ...
    FinderRowItem(name: "Cinderdeck Captures", dateModified: "Today, 10:14 AM", size: "--", kind: "Folder", isFolder: true),
