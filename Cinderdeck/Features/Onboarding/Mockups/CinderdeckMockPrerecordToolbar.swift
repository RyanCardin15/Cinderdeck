//
//  CinderdeckMockPrerecordToolbar.swift
//  Cinderdeck
//
//  100% faithful replica of Cinderdeck's Apple-style RecordingToolbarView for Step 2 onboarding.
//  Layout: [✕] | [📷] | [Area ▾] | [🎙 🔊] | [Options ▾] | [● Record MP4 ▾]
//

import SwiftUI

struct CinderdeckMockPrerecordToolbar: View {
  let onRecord: () -> Void
