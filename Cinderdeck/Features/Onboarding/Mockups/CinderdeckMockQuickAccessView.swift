//
//  CinderdeckMockQuickAccessView.swift
//  Cinderdeck
//
...
struct CinderdeckMockQuickAccessView: View {
  ...
  var body: some View {
    ZStack(alignment: .top) {
      ...
      CinderdeckMockWallpaper(app: .finder).equatable()

      // 2. Finder Window in Background
      desktopContent

      // 3. macOS Menu Bar & Camera Notch
      CinderdeckMockMenuBar(app: .finder).equatable()
  ...
  private var desktopContent: some View {
    VStack(spacing: 0) {
      ...
      CinderdeckMockFinderWindow().equatable()
  ...
  private var stageOverlay: some View {
    ...
    case .prerecordArea:
      ...
      VStack(spacing: 0) {
        ...
        CinderdeckMockPrerecordToolbar(
          onRecord: {
    ...
    case .recordingActive:
      ...
      VStack {
        CinderdeckMockRecordingStatusBar(
    ...
    case .videoEditorOpen:
      ...
      ZStack {
        ...
        CinderdeckMockVideoEditorWindow(
          onReplay: {
            state.resetStep2Flow()
          },
          onExport: {
