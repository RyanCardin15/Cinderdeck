...
extension UTType {
  static let quickAccessAction = UTType("com.cinderdeck.quick-access-action") ?? .text
  static let quickAccessReorder = UTType("com.cinderdeck.quick-access-reorder") ?? .text
}
...
struct QuickAccessActionDragPayload {
  ...
  private static let marker = "com.cinderdeck.quick-access-action"
