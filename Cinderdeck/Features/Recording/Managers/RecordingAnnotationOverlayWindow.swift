...
final class RecordingAnnotationOverlayWindow: NSWindow {
  ...
  /// Tool keys must be observed both inside Cinderdeck (toolbar/status bar focus)
  /// and outside Cinderdeck (the recorded application has focus). A global monitor
  ...
  /// Cinderdeck so they do not fall through to the responder chain and beep.
