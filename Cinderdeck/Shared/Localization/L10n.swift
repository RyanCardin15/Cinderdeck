...
nonisolated enum L10n {
  ...
  enum PreferencesAdvanced {
    ...
    static let urlSchemeDescription = string(
      ...
      defaultValue: "Allow external triggers via cinderdeck:// URLs",
    ...
    static let configSyncQueuedDescription = string(
      ...
      defaultValue: "Sync queued. Cinderdeck will update config.toml shortly.",
    ...
    static let configAccessWarningTitle = string(
      ...
      comment: "Warning title when Cinderdeck has not been granted config folder access"
    )
    static func configAccessWarningDescription(_ path: String) -> String {
      format(
        "preferences-advanced.config-access-warning-description",
        defaultValue: "Grant access to %@ once so Cinderdeck can create config.toml and apply direct edits on launch.",
    ...
    static let configSyncNeedsConfirmation = string(
      ...
      comment: "Toast shown when Cinderdeck needs confirmation before replacing externally changed config.toml"
    )
    ...
    static let configSyncConfirmationMessage = string(
      ...
      defaultValue: "config.toml no longer matches Cinderdeck settings and may have edits from outside the app. Syncing will replace it with current settings.",
    ...
    static func configDirectoryPanelMessage(_ path: String) -> String {
      format(
        ...
        defaultValue: "Grant access for %@. If the folder is missing, Cinderdeck will create it automatically.",
    ...
    static func configDirectoryPanelOnboardingMessage(_ path: String) -> String {
      format(
        ...
        defaultValue: "Grant access for %@. Cinderdeck will create config.toml there if it is missing.",
    ...
    static func configDirectoryMismatch(_ path: String) -> String {
      format(
        ...
        defaultValue: "Choose %@ to keep Cinderdeck config in the default dotfiles location.",
    ...
    static let restoreDefaultsConfirmationMessage = string(
      ...
      defaultValue: "If you confirm, Cinderdeck will replace config.toml with default values, reset app settings, and clear cloud credentials. Saved captures are not deleted.",
  ...
  enum Menu {
    ...
    static let quitCinderdeck = string(
      "menu.quit-cinderdeck",
      defaultValue: "Quit Cinderdeck",
  ...
  enum Onboarding {
    ...
    static let languageSubtitle = string(
      ...
      defaultValue: "Cinderdeck can follow your Mac or preview a specific app language during setup.",
    ...
    static let permissionsSubtitle = string(
      ...
      defaultValue: "Cinderdeck needs permissions for capture, audio, notifications, and save location.",
    ...
    static let turnedOff = string(
      ...
      comment: "Badge shown when notifications are switched off for Cinderdeck in System Settings"
    )
    ...
    static let chooseFolderMessage = string(
      ...
      defaultValue: "Choose a folder for Cinderdeck captures (default: Desktop/Cinderdeck)",
    ...
    static let configAccessSubtitle = string(
      ...
      defaultValue: "Cinderdeck uses a TOML file for portable settings, backups, and dotfile workflows.",
    ...
    static let configAccessFolderDescription = string(
      ...
      defaultValue: "Grant access once. Cinderdeck will create config.toml if needed and apply valid direct edits on launch.",
    ...
    static let configAccessPrivacyNote = string(
      ...
      defaultValue: "This only grants Cinderdeck access to its config folder. It does not import secrets or scan your files.",
    ...
    static let shortcutsSubtitle = string(
      ...
      defaultValue: "Assign system shortcuts to Cinderdeck for quick access.",
    ...
    static let resolveShortcutOverlap = string(
      ...
      comment: "Warning title when system screenshot shortcuts overlap with Cinderdeck shortcuts"
    )
    static let openSettings = string(
    ...
    static let guideStep3 = string(
      ...
      defaultValue: "Uncheck the macOS screenshot shortcuts that overlap with the Cinderdeck shortcuts you want to keep on",
    ...
    static let diagnosticsDescription = string(
      ...
      defaultValue: "Cinderdeck can collect anonymous diagnostic logs when something goes wrong. These logs help us find and fix bugs faster.",
    ...
    static let completionDescription = string(
      ...
      defaultValue: "Cinderdeck is ready. Access it from the menu bar or use your keyboard shortcuts.",
    ...
    static let stepShortcutsSubtitle = string(
      ...
      defaultValue: "Go to System Settings > Keyboard > Keyboard Shortcuts > Screenshots to uncheck ⇧⌘3, ⇧⌘4, and ⇧⌘5 to prevent key conflicts with Cinderdeck. Keep workflows portable with config.toml.",
    ...
    static let stepPermissionsSubtitle = string(
      ...
      defaultValue: "Cinderdeck runs entirely on your Mac. These macOS grants enable screen capture, audio recording, and global shortcuts.",
    ...
    static let permissionsSaveFolderAssurance1 = string(
      ...
      defaultValue: "Cinderdeck only touches its assigned folder (default: Desktop/Cinderdeck).",
    ...
    static let permissionsPrivacyTriggerDetail = string(
      ...
      defaultValue: "Cinderdeck stays completely idle until you press a shortcut. There is zero background scanning of your display.",
    ...
    static let permissionsPrivacySettingsDetail = string(
      ...
      defaultValue: "Withdraw grants in System Settings whenever you like, and Cinderdeck gracefully continues with remaining tools.",
    ...
    static let completionCardSubtitle = string(
      ...
      defaultValue: "Cinderdeck is ready in your menu bar. Take screenshots, record clips, extract text, and annotate anytime.",
    ...
    static let mockShortcutsReady = string(
      ...
      defaultValue: "Cinderdeck shortcuts ready",
  ...
  enum PreferencesGeneral {
    ...
    static let startAtLoginDescription = string(
      ...
      defaultValue: "Launch Cinderdeck when you log in",
    ...
    static let menuBarIconDescription = string(
      ...
      defaultValue: "Access Cinderdeck from the menu bar. When hidden, open Cinderdeck again to show settings.",
      comment: "General preferences setting description"
    )
    ...
    static let languageDescription = string(
      ...
      defaultValue: "Choose the language used across Cinderdeck",
      comment: "General preferences setting description"
    )
    ...
    static let languageRelaunchConfirmationTitle = string(
      ...
      defaultValue: "Relaunch Cinderdeck?",
    ...
    static let languageRelaunchConfirmationMessage = string(
      ...
      defaultValue: "Cinderdeck needs to quit and reopen to apply this language change everywhere.",
    ...
    static let languageRelaunchErrorTitle = string(
      ...
      defaultValue: "Could Not Relaunch Cinderdeck",
    ...
    static let defaultSaveLocation = string(
      ...
      defaultValue: "Desktop/Cinderdeck",
    ...
    static let chooseSaveLocationMessage = string(
      ...
      defaultValue: "Choose where Cinderdeck saves captures",
  ...
  enum PreferencesPermissions {
    static let intro = string(
      ...
      defaultValue: "Cinderdeck requires certain permissions to capture your screen and audio.",
  ...
  enum PreferencesCapture {
    ...
    static let includeInScreenshotsDescription = string(
      ...
      defaultValue: "Show Cinderdeck windows such as Annotate in captured images",
    ...
    static let includeInRecordingsDescription = string(
      ...
      defaultValue: "Show Cinderdeck windows such as Annotate in recorded videos",
      comment: "Capture preferences setting description"
    )
    ...
    static let jpegCutoutNote = string(
      ...
      defaultValue: "Object cutout captures require transparency. Cinderdeck will save them as PNG even when JPEG is selected.",
    ...
    static let ocrNotificationAllowHint = string(
      ...
      defaultValue: "Allow notifications so Cinderdeck can show you the recognized text.",
    ...
    static let ocrNotificationDeniedHint = string(
      ...
      defaultValue: "Notifications are turned off for Cinderdeck in System Settings. OCR still works and copies text to the clipboard.",
  ...
  enum PreferencesAnnotate {
    ...
    static let bringForwardAfterDragDescription = string(
      ...
      defaultValue: "When the editor stays open, bring Cinderdeck to the front and focus Annotate after the drop completes",
  ...
  enum PreferencesShortcuts {
    ...
    static let systemConflictTitle = string(
      ...
      defaultValue: "macOS screenshot shortcuts overlap with Cinderdeck",
    ...
    static let systemConflictDescription = string(
      ...
      defaultValue: "Turn off the overlapping macOS shortcuts to avoid conflicts with the Cinderdeck shortcuts you keep enabled.",
    ...
    static let noConflictsDescription = string(
      ...
      defaultValue: "No overlapping macOS screenshot shortcuts were found for the Cinderdeck shortcuts you currently have enabled.",
    ...
    static let disableShortcutsMessage = string(
      ...
      defaultValue: "You won't be able to capture screenshots or recordings using keyboard shortcuts from any app. You'll need to open Cinderdeck manually to use capture features.",
  ...
  enum Microphone {
    ...
    static let preferencesMessage = string(
      ...
      defaultValue: "Cinderdeck needs microphone permission. Please enable it in System Settings > Privacy & Security > Microphone.",
    ...
    static let recordingMessage = string(
      ...
      defaultValue: "Cinderdeck needs microphone permission to record audio. Please grant access in System Settings.",
  ...
  enum Camera {
    ...
    static let preferencesMessage = string(
      ...
      defaultValue: "Cinderdeck needs camera permission. Please enable it in System Settings > Privacy & Security > Camera.",
      comment: "Alert message when camera permission is missing from the recording toolbar"
    )
    static let recordingMessage = string(
      "camera.recording-message",
      defaultValue: "Cinderdeck needs camera permission to add camera video to the recording. Please grant access in System Settings.",
  ...
  enum CloudTransfer {
    ...
    static let exportDescription = string(
      ...
      defaultValue: "Create an encrypted archive you can import on another Mac. Cinderdeck does not store this archive passphrase.",
    ...
    static let savePanelMessage = string(
      ...
      defaultValue: "Choose where Cinderdeck should save the encrypted credential archive.",
    ...
    static let chooserMessage = string(
      ...
      defaultValue: "Choose a Cinderdeck encrypted credential archive.",
    ...
    static let invalidArchive = string(
      ...
      defaultValue: "The selected file is not a valid Cinderdeck cloud credential archive.",
  ...
  enum CloudSettings {
    ...
    static let importCredentialsMessage = string(
      ...
      defaultValue: "Cinderdeck will load the imported values into the editor. Your current saved configuration stays unchanged until you click Save & Test.",
    ...
    static let googleFolderDescription = string(
      ...
      defaultValue: "Screenshots and videos will be saved under this folder in your Google Drive (default: Cinderdeck).",
    ...
    static let importEncryptedArchiveDescription = string(
      ...
      defaultValue: "Load a previously exported Cinderdeck cloud archive to prefill this form.",
  ...
  enum AnnotateUI {
    ...
    static let saveFailedMessage = string(
      ...
      defaultValue: "Cinderdeck couldn't write to the selected location. Please choose another folder.",
  ...
  enum VideoEditor {
    ...
    static let followMouseOnlyWorksWithCinderdeck = string(
      "video-editor.follow-mouse-only-works-with-cinderdeck",
      defaultValue: "Follow Mouse only works with videos recorded by Cinderdeck after mouse tracking was added.",
    ...
    static func cannotReplaceOriginalMessage(_ details: String) -> String {
      format(
        ...
        defaultValue: "Cinderdeck doesn't have write access to this file location. Save as a copy instead.\n\n%@",
  ...
  enum ScrollingCapture {
    ...
    static let guidanceCinderdeckLockingFirstFrame = string(
      "scrolling-capture.guidance-cinderdeck-locking-first-frame",
      defaultValue: "Cinderdeck is locking the first frame",
    ...
    static let guidanceKeepOneDirectionSoCinderdeckCanRealign = string(
      "scrolling-capture.guidance-keep-one-direction-so-cinderdeck-can-realign",
      defaultValue: "Keep one direction so Cinderdeck can re-align",
    ...
    static let guidanceCinderdeckSealingStitchedResult = string(
      "scrolling-capture.guidance-cinderdeck-sealing-stitched-result",
      defaultValue: "Cinderdeck is sealing the stitched result",
    ...
    static let captionLivePreviewRunning = string(
      ...
      defaultValue: "Live preview running while Cinderdeck locks the stitched frame.",
  ...
  enum Recording {
    ...
    static let saveLocationAccessRequiredMessage = string(
      ...
      defaultValue: "Cinderdeck needs a save folder permission to continue. Please choose a folder in onboarding or grant it now.",
      comment: "Alert message shown when save location access is missing"
    )
    static let chooseSaveLocationMessage = string(
      "recording.choose-save-location-message",
      defaultValue: "Choose where Cinderdeck should save screenshots and recordings",
  ...
  enum CrashReport {
    ...
    static let alertMessage = string(
      ...
      defaultValue: "Cinderdeck bundled your diagnostic logs into one file. Drag the file below to the report page.",
    ...
    static let alertMessageNoLogBundle = string(
      ...
      defaultValue: "Cinderdeck could not prepare a diagnostic log bundle. You can still open the report page and describe the problem.",
  ...
  enum FileAccess {
    nonisolated static let chooseCapturesFolderMessage = string(
      ...
      defaultValue: "Choose where Cinderdeck should save screenshots and recordings",
      comment: "Open panel message shown when Cinderdeck asks the user to grant access to a save folder"
    )
    nonisolated static let grantAccessPrompt = string(
      "file-access.grant-access-prompt",
      defaultValue: "Grant Access",
      comment: "Open panel prompt shown when Cinderdeck asks the user to grant folder access"
    )
    ...
    static let bookmarkSaveFailedMessage = string(
      ...
      defaultValue: "Cinderdeck could not persist access to this folder. Please choose the folder again and confirm permission.",
  ...
  enum ScreenCapture {
    ...
    nonisolated static let saveLocationPermissionRequired = string(
      ...
      comment: "Error shown when Cinderdeck cannot save a screenshot because folder access has not been granted"
    )
    nonisolated static let unableToCaptureSelectedArea = string(
      ...
      comment: "Error shown when Cinderdeck cannot capture the selected screenshot area"
    )
    nonisolated static let failedToCropCapturedImage = string(
      ...
      comment: "Error shown when Cinderdeck captures an image but fails to crop it to the selected area"
    )
    nonisolated static func couldNotCreateDirectory(_ message: String) -> String {
      format(
        ...
        comment: "Error shown when Cinderdeck cannot create the selected save folder. %@ is the underlying filesystem error.",
        message
      )
    }
    ...
    nonisolated static let webpEncodingFailed = string(
      ...
      comment: "Error shown when Cinderdeck cannot encode a screenshot as WebP"
    )
    nonisolated static let couldNotCreateImageDestination = string(
      ...
      comment: "Error shown when Cinderdeck cannot create an image writer for the screenshot"
    )
    nonisolated static let failedToWriteImageToDisk = string(
      ...
      comment: "Error shown when Cinderdeck fails while writing a screenshot to disk"
    )
    nonisolated static func fileWriteVerificationFailed(_ fileName: String) -> String {
      format(
        ...
        comment: "Error shown when Cinderdeck writes a screenshot file but cannot verify it afterward. %@ is the file name.",
        fileName
      )
    }
    ...
    nonisolated static let failedToCreateImageFromFrame = string(
      ...
      comment: "Error shown when Cinderdeck cannot convert a captured stream frame into an image"
    )
  ...
  enum OCR {
    ...
    static let notificationNoTextBody = string(
      ...
      defaultValue: "Cinderdeck could not find readable text in the selected area.",
    ...
    static let notificationFailedBody = string(
      ...
      defaultValue: "Cinderdeck could not recognize text from the selected area.",
    ...
    static let qrTextOnlyUnsupported = string(
      ...
      defaultValue: "QR code detected, but Cinderdeck can only copy text-based QR content.",
  ...
  enum ScrollingCaptureStatus {
    ...
    static let noSavableResultReady = string(
      ...
      defaultValue: "Cinderdeck couldn't lock a savable stitched image yet. You can keep capturing, try Done again, or Cancel.",
    ...
    static let autoScrollNeedsAccessibility = string(
      ...
      defaultValue: "Auto Scroll needs Accessibility permission. Enable Cinderdeck in System Settings > Privacy & Security > Accessibility.",
    ...
    static let mixedDirectionsDetected = string(
      ...
      defaultValue: "Mixed scroll directions detected. Keep one direction so Cinderdeck can align.",
    ...
    static let couldntCaptureLastFrame = string(
      ...
      defaultValue: "Couldn't capture the last frame. Cinderdeck will save the current stitched result.",
    ...
    static let couldntRefreshLastFrame = string(
      ...
      defaultValue: "Couldn't refresh the last frame. Cinderdeck will save the current stitched result.",
    ...
    static let alignmentPaused = string(
      ...
      defaultValue: "Alignment paused. Slow down and keep one direction so Cinderdeck can recover.",
    ...
    static let finalizingCurrentCapture = string(
      ...
      defaultValue: "Finalizing the current capture. Cinderdeck is locking the latest stitched result before saving.",
    ...
    static func finalizingFrames(_ count: Int) -> String {
      format(
        ...
        defaultValue: "Locking the current capture. Cinderdeck is sealing %d stitched frames before saving.",
    ...
    static let finalizingNoNewContent = string(
      ...
      defaultValue: "No new content was detected. Cinderdeck is saving the current stitched result.",
    ...
    static let finalizingCouldntAlignLastFrame = string(
      ...
      defaultValue: "Couldn't align the last frame cleanly. Cinderdeck will save the current stitched result.",
    ...
    static let finalizingHeightLimitReached = string(
      ...
      defaultValue: "Height limit reached. Cinderdeck is saving the current stitched result.",
  ...
  enum AppIdentity {
    ...
    static func outsideApplications(_ bundlePath: String) -> String {
      format(
        ...
        defaultValue: "Install Cinderdeck in /Applications before granting permissions. Current path: %@",
  ...
  enum PreferencesHistory {
    ...
    static let clearHistoryAlertMessage = string(
      ...
      defaultValue: "This will move all capture files to Trash and remove them from History. This action cannot be undone in Cinderdeck.",
  ...
  enum WhatsNew {
    static let title = string(
      "whats-new.title",
      defaultValue: "What's new in Cinderdeck",
    ...
    static let notarizationDesc = string(
      ...
      defaultValue: "Cinderdeck is now officially registered with the Apple Developer Program and certified by Apple, bypassing Gatekeeper's protections for a secure launch.",
