...
private let logger = Logger(subsystem: "Cinderdeck", category: "SandboxFileAccess")
...
final class SandboxFileAccessManager {
  ...
  var defaultExportDirectory: URL {
    if let desktop = FileManager.default.urls(for: .desktopDirectory, in: .userDomainMask).first {
      return desktop.appendingPathComponent("Cinderdeck", isDirectory: true)
    }
    return FileManager.default.homeDirectoryForCurrentUser.appendingPathComponent("Cinderdeck", isDirectory: true)
  }
