...
final class SandboxOffDataMigrationService {
  // This service has no actor-bound teardown. Avoid a Swift runtime executor
  // hop when temporary instances are released during migration/recovery.
  nonisolated deinit {}
  ...
  enum MigrationError: LocalizedError {
    ...
    var errorDescription: String? {
      ...
      case .missingBundleIdentifier:
        return "Could not resolve Cinderdeck bundle identifier for sandbox data migration."
      }
    }
  }
