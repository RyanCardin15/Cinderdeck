...
private nonisolated let logger = Logger(subsystem: "Cinderdeck", category: "ClipboardHelper")
...
enum ClipboardHelper {
  ...
  static func copyImage(_ image: NSImage, format: ImageFormatOption? = nil) {
    ...
    let fileName = "Cinderdeck_clipboard_\(UUID().uuidString).\(ext)"
  ...
  /// `true` when the general pasteboard still holds exactly what Cinderdeck last
  ...
  /// Remembers the file URL(s) Cinderdeck most recently wrote to the general
