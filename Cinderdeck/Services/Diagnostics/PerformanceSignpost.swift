...
nonisolated private let poster = OSSignposter(subsystem: "com.cinderdeck.perf", category: "annotate-return")

@available(macOS 12.0, *)
nonisolated private let capturePassthroughPoster = OSSignposter(
  subsystem: Bundle.main.bundleIdentifier ?? "com.cinderdeck.perf",
