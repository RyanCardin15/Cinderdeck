  ...
  var guidance: ScrollingCaptureSelectionGuidance {
    ...
    case .holdSteady:
      return ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceCinderdeckLockingFirstFrame,
        tone: .progress
      )
    case .slowDown:
      return ScrollingCaptureSelectionGuidance(
        title: L10n.ScrollingCapture.guidanceSlowDown,
        detail: L10n.ScrollingCapture.guidanceKeepOneDirectionSoCinderdeckCanRealign,
        tone: .warning
      )
    case .keepSteadierPace:
      return ScrollingCaptureSelectionGuidance(
    ...
    case .lockingCurrentCapture:
      return ScrollingCaptureSelectionGuidance(
        ...
        detail: L10n.ScrollingCapture.guidanceCinderdeckSealingStitchedResult,
        tone: .progress
      )
    case .savingLongScreenshot:
      return ScrollingCaptureSelectionGuidance(
