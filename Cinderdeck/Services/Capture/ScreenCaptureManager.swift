...
private let logger = Logger(subsystem: "Cinderdeck", category: "ScreenCaptureManager")
...
final class ScreenCaptureManager: ObservableObject {
  ...
  private func performSubprocessProbe() async -> Bool {
    ...
    guard let executableURL = Bundle.main.executableURL,
          executableURL.lastPathComponent.contains("Cinderdeck"),
  ...
  private nonisolated static func verifyFileWritten(at url: URL, maxAttempts: Int = 3, delayMs: UInt64 = 50) async -> Bool {
    let logger = Logger(subsystem: "Cinderdeck", category: "ScreenCaptureManager")
