...
private let recordingMetadataLogger = Logger(subsystem: "Cinderdeck", category: "RecordingMetadata")
...
enum RecordingMetadataStore {
  ...
  private static let appSupportFolderName = "Cinderdeck"
  ...
  private static let legacySidecarExtension = "cinderdeck-recording.json"
