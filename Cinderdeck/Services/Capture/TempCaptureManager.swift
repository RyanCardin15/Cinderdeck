...
private let logger = Logger(subsystem: "Cinderdeck", category: "TempCaptureManager")
...
final class TempCaptureManager {
  ...
  /// Temp directory for unsaved captures (Application Support/Cinderdeck/Captures/).
  ...
  func cleanupOrphanedFiles() {
    ...
    let historyEnabled = defaults.cinderdeckHistoryEnabled
