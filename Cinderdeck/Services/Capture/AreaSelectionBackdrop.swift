...
///
/// Menu extras may close as soon as Cinderdeck presents its selection UI. This preserves only
...
/// A Quick Look preview captured before Cinderdeck presents selection UI.
///
