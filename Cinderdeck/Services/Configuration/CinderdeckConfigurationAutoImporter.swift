//
//  CinderdeckConfigurationAutoImporter.swift
//  Cinderdeck
//
...
enum CinderdeckConfigurationAutoImportStatus: Equatable {
  case applied
  case failed
...
struct CinderdeckConfigurationAutoImportResult {
  let status: CinderdeckConfigurationAutoImportStatus
  let fileURL: URL
  let importResult: CinderdeckConfigurationImportResult?
...
@MainActor
enum CinderdeckConfigurationAutoImporter {
  static func applyIfNeededOnLaunch(
    defaults: UserDefaults = .standard
  ) -> CinderdeckConfigurationAutoImportResult {
  ...
  static func applyIfNeededOnLaunch(
    ...
    if service.needsUserSelectedConfigAccess {
      return CinderdeckConfigurationAutoImportResult(
  ...
  static func applyIfNeeded(
    ...
    let importResult = CinderdeckConfigurationImporter.importTOML(source, defaults: defaults)
