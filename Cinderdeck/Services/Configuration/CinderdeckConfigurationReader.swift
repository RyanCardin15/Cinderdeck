//
//  CinderdeckConfigurationReader.swift
//  Cinderdeck
//
...
struct CinderdeckConfigurationReader {
  let document: SimpleTOMLDocument
  var issues: [CinderdeckConfigurationIssue] = []
  ...
  mutating func error(_ message: String) {
    issues.append(CinderdeckConfigurationIssue(severity: .error, message: message))
  }

  mutating func warning(_ message: String) {
    issues.append(CinderdeckConfigurationIssue(severity: .warning, message: message))
  }
}
