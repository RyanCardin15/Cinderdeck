//
//  CinderdeckConfigurationShortcutsExporter.swift
//  Cinderdeck
//
...
@MainActor
extension CinderdeckConfigurationExporter {
  ...
  private static func writeOverlayShortcut(
    ...
    writer.value("key", CinderdeckConfigurationShortcutCodec.exportKey(config))
    writer.stringArray("modifiers", CinderdeckConfigurationShortcutCodec.exportModifiers(config))
  }
