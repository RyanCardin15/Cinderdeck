...
private let logger = Logger(subsystem: "Cinderdeck", category: "S3MultipartUploader")
...
private final class ThreadSafeDictionary<Key: Hashable, Value>: @unchecked Sendable {
  ...
  private let queue = DispatchQueue(label: "com.cinderdeck.multipart.dictionary", attributes: .concurrent)
