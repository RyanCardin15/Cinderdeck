...
private let logger = Logger(subsystem: "Cinderdeck", category: "GoogleDriveOAuthService")
...
final class GoogleDriveOAuthService: @unchecked Sendable {
  ...
  private let queue = DispatchQueue(label: "com.ryancardin.cinderdeck.oauth")
  ...
  private func sendSuccessResponse(connection: NWConnection) {
    ...
    <head>
      ...
      <title>Cinderdeck Authorization Successful</title>
      <style>
        body {
      ...
      <script>
        // Automatically attempt to redirect back to Cinderdeck
        setTimeout(function() {
          window.location.href = "cinderdeck://settings/cloud";
        }, 1000);
      </script>
    </head>
    <body>
      <div class="container">
        <div class="icon">✓</div>
        <h1>Cinderdeck Authorized!</h1>
        <p>Google Drive authorization was successful. You can close this browser window and return to Cinderdeck to complete your setup.</p>
        <div class="action-btn-container">
          <a href="cinderdeck://settings/cloud" class="btn">Return to Cinderdeck</a>
        </div>
      </div>
    </body>
    </html>
  ...
  private func sendErrorResponse(error: String, connection: NWConnection) {
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Cinderdeck Authorization Failed</title>
      <style>
        body {
          font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
          background-color: #0d0e12;
    ...
    <body>
      <div class="container">
        ...
        <p>Google Drive authorization failed with error: <strong>\(error)</strong>. Please return to Cinderdeck and try again.</p>
        <div class="action-btn-container">
          <a href="cinderdeck://settings/cloud" class="btn">Return to Cinderdeck</a>
        </div>
      </div>
